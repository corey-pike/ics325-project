...
<hr>
  ...
  <div class="row">
    <div class="col-2">
    <label for="name"><b>Search for keywords:</b></label></div>
    <div class="col">
    <input type="text" placeholder="Search for keywords" name="name" id="name" size="50" required></div>
  </div>
  <div class="row">
  <div class="col-2">
...
<div class="row">
  <div class="col-2">
  <label for="location"><b>Between dates: </b></label></div>
    <div class="col">
    <input type="date" placeholder="Pick date" name="location" id="location" required>-<input type="date" placeholder="Pick date" name="location" id="location" required></div>
</div>
<div class="row">
  <div class="col-2">
  ...
  <option value="other">Other</option>
    ...
    <input class="" type="reset" name="reset" value="Reset" />
    <hr>
    </form>
  </div>
</main>
...
$.each(data.card, function(i, f) {
	var cardImg = f.ImageUrl.replace(/'/, "&#39;");
	var tblCell = "<div class='col'><img src='" + cardImg + "'/></div>";
	$(tblCell).appendTo("#card-wrapper");
});
});
});
</script>
